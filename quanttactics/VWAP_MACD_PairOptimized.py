...
freqtrade download-data \
    -c user_data/binance_futures_VWAP_MACD_PairOptimized.json \
    --timerange 20230101- \
...
freqtrade backtesting \
    --strategy VWAP_MACD_PairOptimized \
    --timeframe 1h \
    ...
    --cache none \
    --timeframe-detail 5m \
    -p DOT/USDT:USDT TON/USDT:USDT BCH/USDT:USDT
"""
...
"""
freqtrade webserver \
    --config user_data/binance_futures_VWAP_MACD_PairOptimized.json
"""


class VWAP_MACD_PairOptimized(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:        
        ...
        if pair in self.custom_info:
            ...
            if pair_settings["trend_filter_enabled"]:
                long_conditions.append(dataframe["close"] > dataframe["ema200"])

            long_conditions.append(
                    (dataframe["close"] > dataframe["vwap"]) &

                    (dataframe["close"].rolling(window=pair_settings["vwap_cross_window"]).apply(
