...
freqtrade download-data \
    -c user_data/binance_futures_AroonMacd.json \
    --timerange 20230101- \
...
freqtrade hyperopt \
    --strategy AroonMacd \
    --config user_data/binance_futures_AroonMacd.json \
    --timeframe 1h \
...
class AroonMacd(IStrategy):
    ...
    aroon_cross_window = CategoricalParameter([5, 10, 15], default=10, space="buy")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:        
        ...
        dataframe.loc[
            (   
                ...
                (dataframe["aroonup"].rolling(window=self.aroon_cross_window.value).apply(
